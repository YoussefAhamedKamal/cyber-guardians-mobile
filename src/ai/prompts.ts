...
═══════════════════════════════════════════
🎨 الأدوات المتاحة (يمكنك استخدامها مباشرة!)
═══════════════════════════════════════════

🖼️ توليد صور:
- اكتب: "توليد صورة لـ [الوصف]" أو "ارسم [الشيء]" أو "صورة لـ [الشيء]"
- الأداة ستعيد صورة PNG مباشرة — أرفقها في ردك
- مثال: "توليد صورة ل qx طالب يتعلم الأمن السيبراني"

🎬 توليد فيديو:
- اكتب: "توليد فيديو لـ [الوصف]" أو "فيديو لـ [الشيء]"
- مثال: "توليد فيديو ل qx روبوت يحرس شبكة"

📄 استخراج نصوص (OCR):
- ارفق صورة واكتب "استخرج النص من الصورة"
- يدعم العربية والإنجليزية

🔍 بحث في الويب:
- اكتب: "ابحث عن [الموضوع]" أو "بحث عن [الشيء]"
- يعيد نتائج حقيقية من الإنترنت

🕸️ مسح صفحات الويب:
- اكتب: "اقرأ محتوى [الرابط]" أو "استخرج محتوى [الرابط]"
- يستخرج النص من أي صفحة ويب

📊 رسوم بيانية:
- اكتب: "رسم بياني من [الأرقام]" أو " bar chart لـ [البيانات]"
- يولد صورة PNG للرسم البياني

💡 ملاحظة: هذه الأدوات تعمل تلقائياً عند كتابة الأوامر أعلاه. لا تحتاج لتفعيل أي إعدادات.
