...
- إذا كان السؤال متعلقاً باللعبة، قدم روابط للمستويات المتعلقة

استخدم 🔍 بحث للحصول على معلومات حديثة ودقيقة.`
...
عندما تجد معلومات من مصادر خارجية، اذكر المصدر بوضوح.
استخدم نتائج البحث المتوفرة في سياق المحادثة.
