...
export const levels: LevelData[] = [
  {
    ...
    challengeData: {
      phishingEmails: [
        { id: 'e1', from: 'hr@nexgen-dynamics.com', subject: 'تحديث سياسة الإجازات', body: 'مرحباً، تم تحديث سياسة الإجازات. يرجى مراجعة المرفق.', isPhishing: false, reason: 'إيميل رسمي من الموارد البشرية بدون طلب معلومات' },
        { id: 'e2', from: 'security@nexgen-dynamics.com', subject: 'تغيير كلمة المرور', body: 'عزيزي الموظف، بسبب تحديث أمني، يرجى إرسال كلمة مرورك الحالية إلى هذا الرابط: http://bit.ly/2fake', isPhishing: true, reason: 'رابط مختصر مشبوه وطلب كلمة المرور — شركة حقيقية لا تطلب كلمة سرك' },
        { id: 'e3', from: 'admin@bank-secure.com', subject: 'حسابك البنكي مغلق', body: 'تم إغلاق حسابك البنكي. اضغط هنا لاستعادته: http://bit.ly/3scam', isPhishing: true, reason: 'تهديد بإغلاق الحساب ورابط خارجي — أسلوب التخويف المعتاد' },
        { id: 'e4', from: 'noreply@nexgen-dynamics.com', subject: 'اجتماع الفريق الأسبوعي', body: 'السلام عليكم، الاجتماع الأسبوعي يوم الخميس الساعة 10 صباحاً في قاعة الاجتماعات.', isPhishing: false, reason: 'إيميل داخلي عادي بدون روابط أو طلبات' },
        { id: 'e5', from: 'ceo@nexgen-dynamics.com', subject: 'طلب عاجل جداً', body: 'أنا في اجتماع مع العملاء. أرسل لي 5000 دولار عن طريق ويسترن يونيون وراح أردها بعد الاجتماع.', isPhishing: true, reason: 'طلب تحويل مالي عاجل من المدير — أسلوب انتحال الشخصية' },
        { id: 'e6', from: 'it-support@nexgen.com', subject: 'تحديث أمني عاجل', body: 'عزيزي المستخدم، يرجى تحديث كلمة المرور عبر الرابط: https://portal.nexgen-dynamics.com/reset', isPhishing: false, reason: 'رابط رسمي مشفر (HTTPS) ودعوة لتحديث كلمة المرور بشكل آمن' },
      ],
    },
  },
  {
    ...
    challengeData: {
      passwordRules: [
        { type: 'length', label: '8 أحرف على الأقل', satisfied: false },
        { type: 'uppercase', label: 'حرف كبير واحد على الأقل', satisfied: false },
        { type: 'number', label: 'رقم واحد على الأقل', satisfied: false },
        { type: 'symbol', label: 'رمز خاص واحد على الأقل (!@#$%)', satisfied: false },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    challengeData: {
      firewallPorts: [
        { id: 'p1', name: 'HTTP (تصفح الويب)', port: 80, status: 'open', isCritical: false },
        { id: 'p2', name: 'SSH (تحكم عن بُعد)', port: 22, status: 'open', isCritical: true },
        { id: 'p3', name: 'FTP (نقل ملفات)', port: 21, status: 'open', isCritical: false },
        { id: 'p4', name: 'DNS (أسماء النطاقات)', port: 53, status: 'open', isCritical: true },
        { id: 'p5', name: 'Telnet (قديم جداً)', port: 23, status: 'open', isCritical: false },
        { id: 'p6', name: 'HTTPS (تصفح آمن)', port: 443, status: 'open', isCritical: true },
      ],
    },
  },
  {
