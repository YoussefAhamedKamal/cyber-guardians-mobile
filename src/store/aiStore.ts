...
interface AIStore extends AIState {
  ...
  setToolsActiveSubTab: (tab: 'skills' | 'plugins' | 'connectors' | 'marketplace' | 'analytics' | 'backup' | 'search' | 'ai-assistant' | 'collaboration' | 'security' | 'calendar' | 'reports' | 'agent') => void
